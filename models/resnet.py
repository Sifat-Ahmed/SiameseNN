...
class ResNet(nn.Module):
    def __init__(self, ResBlock, layer_list, num_classes=2, num_channels=3):
...
def ResNet50(num_classes=5, channels=3):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes, channels)


def ResNet101(num_classes=5, channels=3):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes, channels)


def ResNet152(num_classes=5, channels=3):
